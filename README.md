...
*	Exploração Inicial: Carregamento de dados e verificação de integridade (tipos e contagem).
*	Engenharia de Dados: Criação da coluna Receita_Total.
*	Análise de Negócio:
